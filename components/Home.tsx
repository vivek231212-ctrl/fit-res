...
const Home: React.FC = () => {
  return (
    <div style={{ display: "flex", width: "390px", height: "797px", flexDirection: "column", alignItems: "center", gap: "16px", position: "relative", background: "#0F0E11", overflowY: "auto", paddingBottom: "20px" }}>
      {/* Header Section */}
      <div style={{ display: "flex", width: "358px", flexDirection: "column", alignItems: "flex-start", gap: "8px", position: "relative", marginTop: "20px" }}>
        ...
        <div style={{ display: "flex", width: "358px", alignItems: "flex-start", gap: "12px", position: "relative" }}>
          <div layer-name="Search bar" style={{ display: "flex", width: "316px", height: "46px", alignItems: "flex-start", gap: "12px", flexShrink: "0", position: "relative" }}>
      ...
      <div style={{ display: "flex", width: "358px", height: "36px", background: "#030303", borderRadius: "12px", alignItems: "center", padding: "0 12px", justifyContent: "space-between" }}>
      ...
      {/* Filter Tabs Section */}
      <div style={{ display: "flex", width: "350px", overflowX: "auto", gap: "8px", paddingBottom: "4px" }}>
        <div style={{ padding: "8px 12px", background: "#222328", borderRadius: "16px", color: "#CDCDCD", fontSize: "12px", fontFamily: "Quicksand", fontWeight: "500" }}>All</div>
        <div style={{ padding: "8px 12px", background: "#0C180C", borderRadius: "16px", color: "#FFF", border: "0.4px solid #00C600", fontSize: "12px", fontFamily: "Quicksand", fontWeight: "500" }}>High Protein</div>
        <div style={{ padding: "8px 12px", background: "#222328", borderRadius: "16px", color: "#CDCDCD", fontSize: "12px", fontFamily: "Quicksand", fontWeight: "500" }}>Low Kcal</div>
        <div style={{ padding: "8px 12px", background: "#222328", borderRadius: "16px", color: "#CDCDCD", fontSize: "12px", fontFamily: "Quicksand", fontWeight: "500" }}>Gluten Free</div>
      </div>

      {/* Section Title */}
      <div style={{ display: "flex", width: "358px", justifyContent: "space-between", alignItems: "center" }}>
      ...
      {/* Sorting Info */}
      <div style={{ display: "flex", width: "358px", alignItems: "center", gap: "8px" }}>
        <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
           <circle cx="6" cy="6" r="5" stroke="white" strokeWidth="1"/>
           <path d="M6 3V6H8" stroke="white" strokeWidth="1"/>
        </svg>
        <div style={{ color: "#EFEFEF", fontFamily: "Quicksand", fontSize: "10px" }}>Sorted by highest protein</div>
      </div>

      {/* Product List Item 1 */}
      <div style={{ display: "flex", width: "390px", padding: "12px 16px", background: "#18191B", borderBottom: "0.7px dashed #1B1B1B", gap: "16px" }}>
        ...
        <div style={{ width: "100px", display: "flex", flexDirection: "column", alignItems: "center", gap: "8px" }}>
          <div style={{ width: "80px", height: "80px", background: "#222328", borderRadius: "12px", position: "relative", overflow: "hidden" }}>
      ...
      {/* Starter Footer */}
      <div style={{ display: "flex", width: "390px", background: "#1B1B1B", padding: "16px 20px", justifyContent: "space-between", alignItems: "center", marginTop: "auto" }}>
