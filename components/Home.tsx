...
const Home: React.FC = () => {
  return (
    <div style={{ display: "flex", width: "100%", maxWidth: "390px", height: "auto", minHeight: "797px", flexDirection: "column", alignItems: "center", gap: "16px", position: "relative", background: "#0F0E11", overflowY: "visible", paddingBottom: "40px" }}>
      {/* Header Section */}
      <div style={{ display: "flex", width: "100%", maxWidth: "358px", flexDirection: "column", alignItems: "flex-start", gap: "8px", position: "relative", marginTop: "20px", padding: "0 16px" }}>
        ...
        <div style={{ display: "flex", width: "100%", maxWidth: "358px", alignItems: "flex-start", gap: "12px", position: "relative" }}>
      ...
      <div style={{ display: "flex", width: "100%", maxWidth: "358px", height: "36px", background: "#030303", borderRadius: "12px", alignItems: "center", padding: "0 12px", justifyContent: "space-between", margin: "0 auto" }}>
        ...
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
           ...
           {/* Fallback path for visibility if color/background issues occur */}
           <path d="M12.5 10L7.5 5V15L12.5 10Z" fill="white" />
        </svg>
      </div>

      {/* Filter Tabs Section */}
      <div className="no-scrollbar" style={{ display: "flex", width: "100%", maxWidth: "358px", overflowX: "auto", gap: "8px", paddingBottom: "4px", paddingLeft: "16px", paddingRight: "16px", boxSizing: "border-box" }}>
      ...
      {/* Section Title */}
      <div style={{ display: "flex", width: "100%", maxWidth: "358px", justifyContent: "space-between", alignItems: "center", padding: "0 16px" }}>
      ...
      {/* Sorting Info */}
      <div style={{ display: "flex", width: "100%", maxWidth: "358px", alignItems: "center", gap: "8px", padding: "0 16px" }}>
      ...
      {/* Product List Items */}
      <div style={{ display: "flex", width: "100%", maxWidth: "390px", padding: "12px 16px", background: "#18191B", borderBottom: "0.7px dashed #1B1B1B", gap: "16px", boxSizing: "border-box" }}>
      ...
      {/* Starter Footer */}
      <div style={{ display: "flex", width: "100%", maxWidth: "390px", background: "#1B1B1B", padding: "16px 20px", justifyContent: "space-between", alignItems: "center", marginTop: "auto", boxSizing: "border-box" }}>
